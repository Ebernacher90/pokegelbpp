MonsterPalettes:
	...
	db PAL_MEWMON    ; MEW
	db PAL_GREYMON   ; STAHLOS
	db PAL_PURPLEMON ; IKSBAT
	db PAL_BROWNMON  ; RIHORNIOR
	db PAL_REDMON	 ; MAGBRANT
	db PAL_YELLOWMON ; ELEVOLTEK
	db PAL_GREYMON   ; PORYGON2
	db PAL_GREYMON   ; PORYGONZ
	db PAL_BLUEMON	 ; KOKNODON
	db PAL_BLUEMON	 ; RAMEIDON
	db PAL_GREYMON   ; NINCADA
	db PAL_YELLOWMON ; NINJASK
	db PAL_BROWNMON  ; NINJATOM
	db PAL_YELLOWMON ; JIRACHI
	db PAL_GREYMON   ; MAGNEZOPNE
